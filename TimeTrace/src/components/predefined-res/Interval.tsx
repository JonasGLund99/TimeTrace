    ...
    return (
        <form id="interval-re" onSubmit={onSubmit} >
            <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-4">
                    <ModalInput tooltip="The start of the interval" required={true} value={REObject.input.lowerBound} onChange={(e) => { reObject.input.lowerBound = e.target.value; updateREObject();}} label="Lower bound (Inclusive)" placeholder="Enter the start of the interval" ></ModalInput>
                    <ModalInput tooltip="The end of the interval" required={true} value={REObject.input.upperBound} onChange={(e) => { reObject.input.upperBound = e.target.value; updateREObject();}} label="Upper bound" placeholder="Enter the end of the interval" ></ModalInput>
                </div>
            </div>
