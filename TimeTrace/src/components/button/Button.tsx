...
const buttonTypeStyles: ButtonTypeStyles = {
    ...
    [ButtonStyle.Modal]: 'text-github-textWhiteBg bg-github-buttonNavBg border border-github-borderWhiteBg hover:bg-github-highlightedBtnNavBg focus:ring-4 focus:outline-none focus:ring-github-borderWhiteBg font-medium rounded-lg text-xs px-3 py-1.5 text-center inline-flex items-center',
