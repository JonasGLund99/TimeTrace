        ...
        return (
            ...
            {props.displaysMappings && (
              <div className="flex items-center justify-end">
                ...
                />
                <svg onClick={() => {removeMapping(i)}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer">
