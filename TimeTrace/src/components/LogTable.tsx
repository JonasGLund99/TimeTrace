...
function LogTable(props: LogTableProps) {
  ...
  return (
    <div id="fixed-container" className="flex content-center justify-between">
      ...
      <div className="flex flex-col content-center w-[50%]">
        ...
        <input
          type="text"
          className="px-2 border border-gray-600 rounded-lg"
      ...
      <div
        id="log-table"
        className="relative w-[60%] h-[92%] overflow-auto border-2 border-gray-300 p-5 rounded-md"
      >
