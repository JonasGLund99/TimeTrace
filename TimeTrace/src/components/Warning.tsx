...
export default function Warning() {
    ...
    return (
        <div className="h-screen w-screen flex items-center justify-center backdrop-blur-[3px] fixed z-10">
            <div id="alert-additional-content-4" className="w-1/3 p-4 mb-4 text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-time-trace-dark dark:text-yellow-300 dark:border-yellow-800" role="alert">
